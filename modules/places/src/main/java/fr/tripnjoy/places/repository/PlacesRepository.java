package fr.tripnjoy.places.repository;
...
import fr.tripnjoy.places.dto.response.*;
import fr.tripnjoy.places.exception.AddressNotFoundException;
import fr.tripnjoy.places.exception.GeoapifyPlacesException;
import fr.tripnjoy.places.exception.GeocodeAddressException;
...
public class PlacesRepository {
    ...
    public List<PlaceResponse> getPlacesFromAddress(GeocodeAddressRequest request, List<String> categories, int radiusMeter)
    {
    ...
    public List<PlaceResponse> getPlacesFromCoordinates(PlacesFromCoordinatesRequest placesFromCoordinatesRequest, List<String> categories)
    {
