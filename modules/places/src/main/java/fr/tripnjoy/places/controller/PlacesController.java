package fr.tripnjoy.places.controller;
...
import fr.tripnjoy.places.service.PlacesService;
...
public class PlacesController {
    ...
    @ExceptionHandler({GeocodeAddressException.class, GeoapifyPlacesException.class})
    @ResponseBody
